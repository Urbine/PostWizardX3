...
def get_links(wp_posts_f: list[dict]) -> list[str]:
    """Get all post links from the wp posts ``dict``

    :param wp_posts_f: ``list[dict]`` generated by the caching functions.
    :return: ``list[str]`` Post links
    """
    return [url["link"] for url in wp_posts_f]
