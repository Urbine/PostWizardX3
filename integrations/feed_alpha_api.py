...
def feed_alpha_dump_parse(filename: str,
                          dirname: str,
                          partner: str,
                          sep: str,
                          parent: bool = False):
...
if __name__ == '__main__':
    main_url = construct_api_dump_url(FeedAlpha_BASE_URL,
                                      FeedAlpha_CAMPAIGN_ID,
                                      'popularity',
                                      PIPE_SEP, days=30)

    helpers.write_to_file('feed_alpha-dump',
                          'tmp',
                          'csv',
    ...
    result = feed_alpha_dump_parse('feed_alpha-dump', '../tmp',
