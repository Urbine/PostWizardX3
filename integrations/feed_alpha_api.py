"""
Implementation if the FeedAlpha public API.
...
from core.config.config_factories import feed_alpha_conf_factory
...
class FeedAlphaDumpURL:
    """
    Builder class for FeedAlpha URLs.
    """
    ...
    def __init__(
        ...
        self.base_url = FeedAlphaUrl.feed_alpha_base_url
...
def construct_api_dump_url(
    ...
    return (
        f"{FeedAlphaDumpURL(campaign_id, sort_crit, days, url_limit, sep)!s}{csv_columns}"
    )


def feed_alpha_dump_parse(filename: str, dirname: str, partner: str, sep: str) -> str:
    """
...
def main(*args, **kwargs):
    workflow_conf = feed_alpha_conf_factory()
