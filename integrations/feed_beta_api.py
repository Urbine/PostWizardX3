"""
Gather information from the feed_beta API, parse it and insert it into a SQLite3 database.
"""
...
if __name__ == '__main__':
    arg_parser = argparse.ArgumentParser(description='PartnerEight integration - CLI Interface')
