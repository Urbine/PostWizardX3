...
MEDIA_SOURCE_USERNAME = common.get_client_info('client_info.json')['MediaSource']['username']

MEDIA_SOURCE_PASSWD = common.get_client_info('client_info.json')['MediaSource']['password']
...
if __name__ == '__main__':
    ...
    get_vid_dump_flow(FEED_DUMP_URL, 'tmp',
                      (MEDIA_SOURCE_USERNAME, MEDIA_SOURCE_PASSWD), web_driver)
