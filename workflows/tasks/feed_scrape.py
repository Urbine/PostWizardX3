# Accessing MediaSource to get Hosted Videos and links
import datetime

from bs4 import BeautifulSoup

from common import helpers
from tasks import MEDIA_SOURCE_PASSWD, MEDIA_SOURCE_USERNAME, get_partner_name
...
# https://xyz.com/partner-b/video/video_thumbnail.jpg">
# <source src="https://xyz.com/partner-b/video/video_file.mp4" type="video/"/>
# </video>
...
MEDIA_SOURCE_HOSTED_URL = 'https://media_source.com/internal.php?page=adtools&category=3&typeid=23'
FEED_SETS_URL = 'https://media_source.com/internal.php?page=adtools&category=3&typeid=4'
...
if __name__ == '__main__':
    ...
    html_source= get_page_source_flow(FEED_SETS_URL,
...
# <url>https://cdn.example.com/videos/sample_trailer.mp4</url>
# <thumbnail>https://cdn.example.com/videos/sample_trailer.jpg</thumbnail>
# <description>Sample video description</description>
# <tags>sample,tags</tags>
# <vid_link>https://cdn.example.com/videos/sample_trailer.mp4</vid_link>
# <model>Sample Model</model>
# <published_date_nice>2024-09-05 00:00:00</published_date_nice>
# <title>Sample Video</title>
# <tracking_url>join.example.com/track/sample-track-id</tracking_url>
...
# 0          ----> # 4
# 0          ----> # 5
# https://cdn.example.com/videos/sample_trailer.mp4 ----> # 6
# https://cdn.example.com/videos/sample_trailer.jpg ----> # 7
# Sample video description ----> # 8
# 1                                                             ----> # 9
# sample,tags ----> # 10
# 3         ----> # 11
# 0         ----> # 12
...
# 2         ----> # 19
#           ----> # 20
# https://cdn.example.com/videos/sample_trailer.mp4  ----> # 21
# Sample Model ----> # 22
# ?          ----> # 23
#            ----> # 24
# 5          ----> # 25
...
# Sample Video                       ----> # 41
# join.example.com/track/sample-track-id   ----> # 42
# sample-track-id                              ----> # 43

# ==== XML PARSING ====

# Entry element that contains all the videos
# <entry id="sample-adtool:2::1725508800" name="Sample Video">
# <adtoolid>sample-adtool</adtoolid>
# <identid>5</identid>
# <siteid>2</siteid>
...
# <encoded>sample-track-id</encoded>
# </item>
# <published_date_nice>2024-09-05 00:00:00</published_date_nice>
# <title>Sample Video</title>
# <tracking_url>join.example.com/track/sample-track-id</tracking_url>
...
# <td><textarea class="display-link-text" rows="2">&lt;script type="text/plain"
# src="https://media_source.com/jscript/flowplayer.js"&gt;&lt;/script&gt;&lt;
# div class="video_holder_14105 table-video-small"&gt;&lt;/div&gt;&lt;script&gt;
# flowplayer("div.video_holder_14105", {src:'https://media_source.com/flash/flowplayer.swf', width: 386, height: 386},
# {playlist: ['https://cdn.example.com/hlb/video/sample_video.jpg',
# {autoPlay: false,autoBuffering: false,loop: false,
# url: 'https://cdn.example.com/hlb/video/sample_video.mp4',
# linkUrl: "https://join.example.com/track/sample-id2"}],
...
# <option value="16">PartnerOne - Membership</option>
# <option value="30">PartnerFour - Membership</option>
# <option value="21">Sample Membership</option>
# <option value="28">Sample Membership</option>
# <option value="27">PartnerFive - Membership</option>
# <option value="29">Screw Me Too - Membership</option>
# <option value="14">PartnerSix - Membership</option>
# <option value="2">PartnerThree - Membership</option>
# <option value="15">PartnerTwo - Membership</option>
# </select>
