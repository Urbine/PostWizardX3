...
def get_page_source_flow(url_: str,
    ...
    with webdrv as driver:
            ...
            partner_name = feed_dump_create.get_partner_name(partner_options, int(selection))
            time.sleep(1)
...
if __name__ == '__main__':
    ...
    media_source_hosted_vids = 'https://media_source.com/internal.php?page=adtools&category=3&typeid=23'
    media_source_downloadable_sets = 'https://media_source.com/internal.php?page=adtools&category=3&typeid=4'

    html_source= get_page_source_flow(media_source_downloadable_sets,
