"""
Job control module (update_media_source_chain) controls the order of execution
...
*** Steps to update the databases from MediaSource ***
...
if __name__ == '__main__':
    ...
    photoset_source = get_page_source_flow(
        media_source_downloadable_sets, (username, password),
