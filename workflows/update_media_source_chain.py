"""
Bot module (update_media_source_chain) controls the order of execution
...
if __name__ == "__main__":
    ...
    logging_setup(update_media_source_conf(), __file__)
    ...
    with console.status(
        "Getting Dump File from MediaSource. Please wait...", spinner="bouncingBall"
    ):
    ...
    with console.status(
        "Getting all available Photo Sets from MediaSource. Please wait...",
