...
This module provides functionality to assist with video embedding tasks from various
content providers. It automates the process of adding video posts to a WordPress
    ...
    for num, vid in enumerate(not_published):
        ...
        if add_post:
            ...
            transformed_iframe = transform_partner_iframe(
                db_interface.get_embed(), "https://video.example.com"
            )
            models = (
                author
            ...
            try:
                ...
                with console.status(
                    ...
                    post_meta_payload = (
                        PostMetaPayload()
                        .content_region(
                            ContentRegion.SOUTH_ASIAN
                            if partner.startswith("FeedBeta")
                            else ContentRegion.ASIA
                        )
                        .hd(ToggleField.ON)
