"""
MediaSource Content Upload Assistant

This module implements utilities to automate the process of uploading videos and gallery content
from MediaSource to WordPress. It provides command-line interfaces and functions to:
...
content management solution for MediaSource partners, allowing for efficient
batch processing of content from databases created by update_media_source_chain.py.
...
from core.models.config_model import ContentBotConf
...
from workflows.utils.strings import (
    mask_media_source_tracking_link,
    transform_media_source_hosted_link,
)
...
def video_upload_pilot(
    ...
    cs_config: ContentBotConf = content_bot_conf_factory()
    ...
    for num, vid in enumerate(not_published_yet):
        ...
        if add_post:
            ...
            payload = WorkflowPostPayloadBuilder().payload_factory_media_source(
                wp_slug,
                general_config.default_status,
                title,
                description,
                mask_media_source_tracking_link(tracking_url, "https://join.example.com"),
                ...
                with console.status(
                    ...
                    if push_post == 201:
                        ...
                        post_meta_builder = (
                            ...
                            .content_format(ContentFormat.SINGLE)
                            .video_url(
                                f"{target_video_base_url}{transform_media_source_hosted_link(source_url)}"
                            )
                            .hd(ToggleField.ON)
                            .visual_attribute(VisualAttribute.DARK)
