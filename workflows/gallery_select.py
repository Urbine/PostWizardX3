...
from core import helpers, MEDIA_SOURCE_INFO, WP_CLIENT_INFO, GALLERY_SEL_CONF
...
def fetch_zip(
        ...
        gecko: bool = False,
        headless: bool = False,
        media_source_auth: MediaSourceAuth = MEDIA_SOURCE_INFO
) -> None:
    ...
    :param parent: ``bool``  ``True`` if your download dir is in MEDIA_SOURCE_INFOa parent directory. Default ``False``
...
def gallery_upload_pilot(
    ...
    :param gallery_sel_conf: ``GalleryBotConf`` object with configuration options for this module.
    :return: ``None``
    """
