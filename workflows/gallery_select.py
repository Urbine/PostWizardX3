...
from core.models.config_model import GalleryBotConf
...
from workflows.utils.file_handling import fetch_zip, extract_zip, upload_image_set
...
def gallery_upload_pilot(
    ...
    gallery_sel_conf: GalleryBotConf = gallery_bot_conf_factory()
    ...
    for num, photo in enumerate(not_published_yet):
        ...
        if add_post:
            ...
            payload: dict[str, str | int] = (
                PhotoPostPayloadBuilder().photos_payload_factory(
