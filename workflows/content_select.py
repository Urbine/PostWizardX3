...
def video_upload_pilot(
    ...
    In other words, this function gives continuity to what ``workflows.update_media_source_chain`` does with
    ...
    :param cs_config: ``ContentBotConf`` Object that contains configuration options for this module.
