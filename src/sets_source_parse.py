...
def parse_links(soup_html: BeautifulSoup):
    base_url = 'https://media_source.com/'
...
def db_generate(soup_html: BeautifulSoup, db_suggest: list[str]):
    ...
    db_name = helpers.db_creation_helper(db_suggest)
...
db_name_suggest = ["partner_one_photo_sets.db",
                       "partner3_photo_sets.db",
                       "partner2_photo_sets.db"]
