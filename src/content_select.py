    ...
    * Note: This won't be a detailed description, however, it will give you a better notion of how this
    ...
    for num, vid in enumerate(not_published_yet[:]):
        ...
        if add_post:
            ...
            all_models_wp = wordpress_api.map_wp_model_id(wp_posts_f, 'authors', 'authors')
...
if __name__ == '__main__':
    ...
    banner_partner2_2 = "https://media_source.com/view_banner.php?name=partner2-960x75.gif&amp;filename=9935_name.gif&amp;type=gif&amp;download=1"
    ...
    banner_partner1_1 = "https://media_source.com/view_banner.php?name=partner1-638x60.gif&amp;filename=7654_name.gif&amp;type=gif&amp;download=1"
    banner_partner1_2 = "https://media_source.com/view_banner.php?name=partner1-850x80.gif&amp;filename=7655_name.gif&amp;type=gif&amp;download=1"
    banner_partner1_3 = "https://media_source.com/view_banner.php?name=partner1-728x90.gif&amp;filename=9876_name.gif&amp;type=gif&amp;download=1"
    banner_partner3_1 = "https://media_source.com/view_banner.php?name=tp-728x90.gif&amp;filename=9924_name.gif&amp;type=gif&amp;download=1"
    banner_partner3_2 = "https://media_source.com/view_banner.php?name=tp-770x76.gif&amp;filename=9926_name.gif&amp;type=gif&amp;download=1"
    ...
    banner_partner4_2 = "https://media_source.com/view_banner.php?name=esd-660x60-2.png&filename=12421_name.png&type=png&download=1"
    ...
    banner_lists = [banner_lst_partner1, banner_lst_partner2, banner_lst_partner3, banner_lst_partner4]
    ...
    partnerz = ["PartnerOne", "PartnerTwo", "PartnerThree", "PartnerFour"]
