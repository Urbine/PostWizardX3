    ...
    for vid in all_vals:
        ...
        if not is_published(title,cursor_wp):
            ...
            if input('\nAdd post to WP? -> Y/N: ').lower() == ('y' or 'yes'):
                ...
                img_attrs = {"alt_text": f"{title} - {description}. Watch it now on example.com",
                            "caption": f"{title} - {description}. Watch it now on example.com",
                            "description": f"{title} - {description}. Watch it now on example.com"}
