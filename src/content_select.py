...
def get_model_ids(wp_posts_f: list[dict], model_lst: list[str]) -> list[int]:
    ...
    :return: list[int]
    """
    model_tracking: dict[str, int] = wordpress_api.map_wp_class_id(wp_posts_f, 'authors', 'authors')
    ...
    * Note: This won't be a detailed description, however, it will give you a better notion of how this
    ...
    for num, vid in enumerate(not_published_yet[:]):
        ...
        if add_post:
            ...
            all_models_wp = wordpress_api.map_wp_class_id(wp_posts_f, 'authors', 'authors')
...
if __name__ == '__main__':
    ...
    banner_lists = [banner_lst_partner1,
                    banner_lst_partner2,
                    banner_lst_partner3,
                    banner_lst_partner4,
                    banner_lst_partner5]
