...
for MediaSource affiliate partner offers. This bot integrates video processing, content
...
from core.config.config_factories import content_bot_conf_factory


class MediaSourceContentBot(ContentBotFlow):
    def __init__(self, load_assets: bool = True, parent: bool = False):
        super().__init__(content_bot_conf_factory(), parent=parent)
    ...
    def _build_payload(self) -> Dict[str, str | int]:
        ...
        from workflows.utils.strings import mask_media_source_tracking_link
    ...
    def _build_post_meta_payload(self):
        ...
        post_meta_builder = (
            ...
            .video_url(
                f"{target_video_base_url}{transform_media_source_hosted_link(self._source_url)}"
            )
            .hd(ToggleField.ON)
