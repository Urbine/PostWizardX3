...
def media_source_auth() -> MediaSourceAuth:
    ...
    """
    return MediaSourceAuth(
        username=client_info["MediaSource"]["username"],
        password=client_info["MediaSource"]["password"],
    )
...
def update_media_source_conf() -> UpdateMediaSource:
    ...
    """
    return UpdateMediaSource(
        logging_dirname=workflows_config["update_media_source_chain"]["logging_dirname"]
    )
