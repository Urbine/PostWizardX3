...
from core.controllers.secrets_controller import (
    ...
    media_source_update_credentials,
    media_source_remove_credentials,
    ...
    with gr.Row():
        with gr.Column():
            ...
            with gr.Tab("Content Providers"):
                gr.Markdown("## MediaSource")
                media_source_username = gr.Textbox(
                    label="Username",
                    info="The username for your MediaSource Affiliate Account",
                )
                media_source_password = gr.Textbox(
                    label="Password",
                    info="The password for your MediaSource Affiliate Account",
                    type="password",
                )

                store_media_source_secrets = gr.Button("Store MediaSource Credentials")
                store_media_source_secrets.click(
                    fn=media_source_update_credentials,
                    inputs=[media_source_username, media_source_password],
                    outputs=[],
                )

                delete_media_source_secrets = gr.Button("Delete MediaSource Credentials")
                delete_media_source_secrets.click(
                    fn=media_source_remove_credentials, inputs=[], outputs=[]
                )
