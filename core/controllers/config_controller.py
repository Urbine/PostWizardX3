...
def save_config(conf_values: ConfigModelDict) -> None:
    config_results = [
        ...
        AIConfig.write_llm_model_tag(conf_values["llm_model_tag"]),
        AIConfig.write_llm_provider(conf_values["llm_providers"]),
        AIConfig.write_llm_provider_host(conf_values["llm_host"]),
        AIConfig.write_llm_port(conf_values["llm_port"]),
...
def collect_config_state(
    ...
    config_states: ConfigModelDict = {
        ...
        "llm_model_tag": model_tag,
        "llm_providers": providers,
        "llm_host": provider_host,
        "llm_port": provider_port,
...
def load_config_fields() -> List[Any]:
    ...
    config = ConfigModelDict(
        ...
        llm_providers=ai_config_factory().llm_provider,
        llm_model_tag=ai_config_factory().llm_model_tag,
        llm_host=ai_config_factory().llm_serve_host,
        llm_port=ai_config_factory().llm_serve_port,
