...
class ContentBotConfig(SocialConfig):
    """
    Class for writing the MediaSource Content Bot configuration options to the ``workflows_config.ini`` file.
    """
    ...
    def write_partner_names(partners: str) -> bool:
        ...
        ConfigWriter.config_validate(
            ContentBotConfig.write_partner_names, partners
        )
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.PARTNERS, partners
        )

    @staticmethod
    def write_media_source_db_query(sql_query: str) -> bool:
        """
        Write the MediaSource video database query to the configuration file.

        :param sql_query: ``str`` -> The SQL query to set.
        :return: ``bool`` -> ``True`` if the write operation was successful, ``False`` otherwise.
        """
        ConfigWriter.config_validate(
            ContentBotConfig.write_media_source_db_query, sql_query
        )
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.SQL_QUERY, sql_query
        )
    ...
    def write_assets_enabled(value: bool) -> bool:
        ...
        :return: ``bool`` -> ``True`` if the write operation was successful, ``False`` otherwise.
        """
        ConfigWriter.config_validate(ContentBotConfig.write_assets_enabled, value)
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.ASSETS_ENABLED, value
        )

    @staticmethod
    def write_telegram_sharing(value: bool) -> bool:
        ConfigWriter.config_validate(
            ContentBotConfig.write_telegram_sharing, value
        )
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.TELEGRAM_SHARING, value
        )

    @staticmethod
    def write_x_posting_auto(value: bool) -> bool:
        ConfigWriter.config_validate(ContentBotConfig.write_x_posting_auto, value)
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.X_POSTING_AUTO, value
        )

    @staticmethod
    def write_telegram_sharing_auto(value: bool) -> bool:
        ConfigWriter.config_validate(
            ContentBotConfig.write_telegram_sharing_auto, value
        )
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.TELEGRAM_SHARING_AUTO, value
        )

    @staticmethod
    def write_x_social_posting(value: bool) -> bool:
        ConfigWriter.config_validate(
            ContentBotConfig.write_x_social_posting, value
        )
        return ConfigWriter.write_entry(
            ConfigSection.CONTENT_BOT, ConfigOption.X_POSTING, value
        )


class GalleryBotConfig(ContentBotConfig):
    """
    Class for writing the MediaSource Gallery Bot configuration options to the ``workflows_config.ini`` file.
    """
    ...
    def write_partner_names(partners: str) -> bool:
        ConfigWriter.config_validate(
            GalleryBotConfig.write_partner_names, partners
        )
        return ConfigWriter.write_entry(
            ConfigSection.GALLERY_BOT, ConfigOption.PARTNERS, partners
        )

    @staticmethod
    def write_media_source_db_query(sql_query: str) -> bool:
        ConfigWriter.config_validate(
            GalleryBotConfig.write_media_source_db_query, sql_query
        )
        return ConfigWriter.write_entry(
            ConfigSection.GALLERY_BOT, ConfigOption.SQL_QUERY, sql_query
        )

    @staticmethod
    def write_telegram_sharing(value: bool) -> bool:
        ConfigWriter.config_validate(
            GalleryBotConfig.write_telegram_sharing, value
        )
        return ConfigWriter.write_entry(
            ConfigSection.GALLERY_BOT, ConfigOption.TELEGRAM_SHARING, value
        )

    @staticmethod
    def write_x_posting_auto(value: bool) -> bool:
        ConfigWriter.config_validate(GalleryBotConfig.write_x_posting_auto, value)
        return ConfigWriter.write_entry(
            ConfigSection.GALLERY_BOT, ConfigOption.X_POSTING_AUTO, value
        )

    @staticmethod
    def write_telegram_sharing_auto(value: bool) -> bool:
        ConfigWriter.config_validate(
            GalleryBotConfig.write_telegram_sharing_auto, value
        )
        return ConfigWriter.write_entry(
            ConfigSection.GALLERY_BOT, ConfigOption.TELEGRAM_SHARING_AUTO, value
        )

    @staticmethod
    def write_x_social_posting(value: bool) -> bool:
        ConfigWriter.config_validate(
            GalleryBotConfig.write_x_social_posting, value
        )
        return ConfigWriter.write_entry(
            ConfigSection.GALLERY_BOT, ConfigOption.X_POSTING, value
        )


class VidEmbedAssistBotConfig(ContentBotConfig):
    """
    ...
    def write_media_source_db_query(sql_query: str) -> bool:
        ConfigWriter.config_validate(
            VidEmbedAssistBotConfig.write_media_source_db_query, sql_query
        )
        return ConfigWriter.write_entry(
...
class FeedAlphaConfig:
    """
    Class for writing configuration options related to the FeedAlpha feed.
    """
    ...
    def write_campaign_id(campaign_id: int) -> bool:
        ...
        :return: ``bool`` -> ``True`` if the write operation was successful, ``False`` otherwise.
        """
        ConfigWriter.config_validate(FeedAlphaConfig.write_campaign_id, campaign_id)
        return ConfigWriter.write_entry(
            ConfigSection.FEED_ALPHA, ConfigOption.CAMPAIGN_ID, campaign_id
        )


class FeedBetaConfig:
    """
    Class for writing configuration options related to the FeedBeta feed.
    """
    ...
    def write_source_id(source_id: int) -> bool:
        ...
        :return: ``bool`` -> ``True`` if the write operation was successful, ``False`` otherwise.
        """
        ConfigWriter.config_validate(FeedBetaConfig.write_source_id, source_id)
        return ConfigWriter.write_entry(
            ConfigSection.FEED_BETA, ConfigOption.SOURCE_ID, source_id
        )


class FeedDeltaConfig:
    """
    Class for writing configuration options related to the FeedDelta feed.
    """
    ...
    def write_campaign_utm(campaign_utm: str) -> bool:
        ...
        :return: ``bool`` -> ``True`` if the write operation was successful, ``False`` otherwise.
        """
        ConfigWriter.config_validate(FeedDeltaConfig.write_campaign_utm, campaign_utm)
        return ConfigWriter.write_entry(
            ConfigSection.FEED_DELTA, ConfigOption.CAMPAIGN_UTM, campaign_utm
        )
