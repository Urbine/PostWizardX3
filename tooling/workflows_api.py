...
from core.models.secret_model import MediaSourceAuth
...
def asset_parser(bot_config: ContentBotConf, partner: str):
...
def make_img_payload(
    ...
    :param general_config: ``ContentBotConf`` Uses general configuration options to customise payloads.
