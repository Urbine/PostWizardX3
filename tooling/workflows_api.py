...
from core.models.secret_model import MediaSourceAuth, SecretType, WPSecrets
...
def social_sharing_controller(
    ...
    description: str,
    wp_slug: str,
    cs_config: Union[ContentBotConf, GalleryBotConf, EmbedAssistBotConf],
    wordpress_site: WordPress,
) -> None:
    ...
    :param cs_config: ``ContentBotConf`` | ``GalleryBotConf`` | ``EmbedAssistBotConf``
    :param wordpress_site: ``WordPress`` class instance responsible for managing all the
                             WordPress site data
    :return: ``None``
    """
...
def pilot_warm_up(
    ...
    :param cs_config: ``ContentBotConf | GalleryBotConf | EmbedAssistBotConf`` Object
    ...
    try:
        ...
        with console.status(
            ...
            if isinstance(cs_config, (ContentBotConf, EmbedAssistBotConf)):
                logging.info(
        ...
        elif cs_config.__class__.__name__ == "ContentBotConf":
...
def fetch_zip(
    ...
    **For this reason, refrain from using headless mode with this module.**
    ...
    media_source_auth: MediaSourceAuth = SecretHandler().get_secrets(
