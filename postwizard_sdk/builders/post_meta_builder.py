...
class PostMetaNestedPayload(NestedPayloadBuilder):
    ...
    def creator_tier(self, creator_tier: CreatorTier) -> Self:
        return self._plus(PostMetaKey.CREATOR_TIER, creator_tier.value)
    ...
    def content_format(self, content_format: ContentFormat) -> Self:
        return self._plus(PostMetaKey.CONTENT_FORMAT, content_format.value)

    def content_region(self, content_region: ContentRegion) -> Self:
        return self._plus(PostMetaKey.CONTENT_REGION, content_region.value)

    def visual_attribute(self, visual_attribute: VisualAttribute) -> Self:
        return self._plus(PostMetaKey.VISUAL_ATTRIBUTE, visual_attribute.value)
