...
.. note::
   If you work with the MediaSource affiliate program, the database schema generated by
...
.. tip::
   ...
   .. code-block:: ini
      ...
      [bar_partner] # "banner" or "image" is not necessary, though.
...
The only exception in this list is ``workflows.update_media_source_chain`` since it coordinates the
